...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { description: @movement.description, display_name: @movement.display_name, name: @movement.name, price: @movement.price, time: @movement.time } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { description: @movement.description, display_name: @movement.display_name, name: @movement.name, price: @movement.price, time: @movement.time } }
